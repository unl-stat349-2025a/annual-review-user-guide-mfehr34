...
The next prerequisite is a basic understanding of the R programming language and RStudio. Knowing how to create a new R script file, run lines of code, and where the output is generated will make this walk-trhough go smoothly.
...
4.  Install and import the **DescTools** library (for Step 4).
...
## Conclusion {#common-errors-and-fixes}
